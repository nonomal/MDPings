...
data class StatusDto(
    ...
    @SerialName(value = "SwapUsed") val swapUsed: Int,
    ...
    @SerialName(value = "NetInSpeed") val netInSpeed: Int,
    @SerialName(value = "NetOutSpeed") val netOutSpeed: Int,
    @SerialName(value = "Uptime") val uptime: Int,
